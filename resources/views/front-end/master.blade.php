<!--
    ...
    <link href='../../../../../css?family=Cagliostro' rel='stylesheet' type='text/css'>
    <link href='../../../../../css-1?family=Open+Sans:400,800italic,800,700italic,700,600italic,600,400italic,300italic,300' rel='stylesheet' type='text/css'>
    <!--search jQuery-->
    ...
    <script src="{{ '/' }}front-end/js/responsiveslides.min.js"></script>
     ...
     <!--mycart-->
    <script type="text/javascript" src="{{ '/' }}front-end/js/bootstrap-3.1.1.min.js"></script>
     <!-- cart -->
    <script src="{{ '/' }}front-end/js/simpleCart.min.js"></script>
    <!-- cart -->
      <!--start-rate-->
    <script src="{{ '/' }}front-end/js/jstarbox.js"></script>
    ...
    <script async="" src='../../../../../gtag/js?id=UA-149859901-1'></script>
    <script>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu multi-column columns-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3  multi-gd-img">
                                                            <a href="products.html"><img src="{{ '/' }}front-end/images/woo.jpg" alt=" "></a>
                                                    </div>
                                                    <div class="col-sm-3  multi-gd-img">
                                                            <a href="products.html"><img src="{{ '/' }}front-end/images/woo1.jpg" alt=" "></a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </ul>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu multi-column columns-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3  multi-gd-img">
                                                            <a href="products1.html"><img src="{{ '/' }}front-end/images/woo3.jpg" alt=" "></a>
                                                    </div>
                                                    <div class="col-sm-3  multi-gd-img">
                                                            <a href="products1.html"><img src="{{ '/' }}front-end/images/woo4.jpg" alt=" "></a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </ul>
                                ...
                                <div class="cart box_1">
                                    <a href="checkout.html">
                                        <h3> <div class="total">
                                            ...
                                            <img src="{{ '/' }}front-end/images/bag.png" alt="">
                                        </h3>
                                    </a>
                        ...
                        <div class="copy-section">
                            <div class="container">
                                ...
                                <div class="copy-right">
                                    <img src="{{ '/' }}front-end/images/card.png" alt="">
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
